...
import { calculateStreaks, getDaysUntilNextMilestone, getStreakStatusMessage, isStreakActive } from "@/lib/utils/streaks";
...
export const useStreaks = (): UseStreaksReturn => {
  ...
  const { daysUntil: daysUntilNextMilestone, milestone: nextMilestone } = getDaysUntilNextMilestone(streakData.currentStreak);
