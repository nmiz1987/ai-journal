...
import { Button, Card, H1, Input, Label, Paragraph, ScrollView, Spacer, XStack, YStack } from "tamagui";
        ...
        <ScrollView flex={1} bg="$background" contentContainerStyle={{ flex: 1 }}>
          <YStack flex={1} p="$4" gap="$4" style={{ justifyContent: "center", minHeight: "100%" }}>
            ...
            <XStack gap="$2" style={{ justifyContent: "center", alignItems: "center" }}>
              ...
              <Button variant="outlined" size="$3" borderColor="#904BFF" color="#904BFF" onPress={() => setPendingVerification(false)}>
                Resend
              </Button>
            </XStack>
          </YStack>
      ...
      <ScrollView flex={1} bg="$background" contentContainerStyle={{ flex: 1 }}>
        <YStack flex={1} p="$4" gap="$4" style={{ justifyContent: "center", minHeight: "100%" }}>
          ...
          <XStack gap="$2" style={{ justifyContent: "center", alignItems: "center" }}>
            ...
            <Button variant="outlined" size="$3" borderColor="#904BFF" color="#904BFF" onPress={() => router.canGoBack() && router.back()}>
              Sign In
            </Button>
          </XStack>
        </YStack>
